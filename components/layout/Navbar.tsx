    ...
    <nav className="border-b border-white/5 bg-black/40 backdrop-blur-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-8 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          {!isLoading && !isPremium && (
            <a href="/upgrade" className="text-xs text-amber-400 border border-amber-400/30 rounded-full px-4 py-1.5 hover:bg-amber-400/10 transition-colors tracking-wide">
              Upgrade to Elite
            </a>
          )}
          <Link href="/account" className="text-xs text-white/30 hover:text-white/60 transition-colors tracking-wide">
            Account
          </Link>
          <button
